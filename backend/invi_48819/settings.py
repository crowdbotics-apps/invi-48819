"""
Django settings for invi_48819 project.
...
WSGI_APPLICATION = 'invi_48819.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "invi Support <support@invi-48819.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "invi_48819 API",
    "DESCRIPTION": "API documentation for invi_48819 App",
    "VERSION": "v1",
}
